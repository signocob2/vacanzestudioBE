...
(
    ...
    pagamento_carta_bonifico        VARCHAR2(1) DEFAULT 'C'               NOT NULL,
    CONSTRAINT VF_FLAG_CHK_PAGAM_COL CHECK (pagamento_carta_bonifico IN ('C', 'B')),
    timestamp_inserimento           TIMESTAMP   DEFAULT CURRENT_TIMESTAMP NOT NULL,
    utente_inserimento              VARCHAR2(50),
    timestamp_modifica              TIMESTAMP   DEFAULT CURRENT_TIMESTAMP NOT NULL,
    utente_modifica                 VARCHAR2(50),
...
(
    ...
    descrizione_attivita  VARCHAR2(300)                       NOT NULL,
    timestamp_inserimento TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    utente_inserimento    VARCHAR2(50),
    timestamp_modifica    TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    utente_modifica       VARCHAR2(50),
...
(
    ...
    pagamento_carta_bonifico         VARCHAR2(1) DEFAULT 'C'               NOT NULL,
    CONSTRAINT VF_FLAG_CHK_PAGAM_FAM CHECK (pagamento_carta_bonifico IN ('C', 'B')),
    timestamp_inserimento            TIMESTAMP   DEFAULT CURRENT_TIMESTAMP NOT NULL,
    utente_inserimento               VARCHAR2(50),
    timestamp_modifica               TIMESTAMP   DEFAULT CURRENT_TIMESTAMP NOT NULL,
    utente_modifica                  VARCHAR2(50),
...
(
    ...
    distanza_centro_citta_km          NUMBER(5, 2)                          NOT NULL,
    timestamp_inserimento             TIMESTAMP   DEFAULT CURRENT_TIMESTAMP NOT NULL,
    utente_inserimento                VARCHAR2(50),
    timestamp_modifica                TIMESTAMP   DEFAULT CURRENT_TIMESTAMP NOT NULL,
    utente_modifica                   VARCHAR2(50),
...
(
    id_certificato        NUMBER GENERATED BY DEFAULT AS IDENTITY,
    id_utente             NUMBER                              NOT NULL,
    id_vacanza            NUMBER                              NOT NULL,
    livello_raggiunto     VARCHAR2(2)                         NOT NULL,
    timestamp_inserimento TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    utente_inserimento    VARCHAR2(50),
    timestamp_modifica    TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    utente_modifica       VARCHAR2(50),
...
CREATE UNIQUE INDEX
    CERTIFICATO_UNQ_IDX1
    ON
        CERTIFICATO (id_utente, id_vacanza);

---------------------------------------------------------------------
--QUESTIONARIO
CREATE TABLE QUESTIONARIO
(
    id_questionario         NUMBER GENERATED BY DEFAULT AS IDENTITY,
    id_utente               NUMBER                              NOT NULL,
    id_vacanza              NUMBER                              NOT NULL,
    esperienza_positiva     NUMBER(1)                           NOT NULL,
    alloggio_curato         NUMBER(1)                           NOT NULL,
    personale_disponibile   NUMBER(1)                           NOT NULL,
    utile_per_lingua        NUMBER(1)                           NOT NULL,
    prezzo_gite_appropriato NUMBER(1)                           NOT NULL,
    voto_gradimento         NUMBER(2)                           NOT NULL,
    commento_libero         VARCHAR2(500)                       NOT NULL,
    is_compilato            VARCHAR2(1)                         NOT NULL,
    CONSTRAINT VF_FLAG_CHK_IS_COMPILATO CHECK (is_compilato IN ('N', 'S')),
    timestamp_inserimento   TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    utente_inserimento      VARCHAR2(50),
    timestamp_modifica      TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    utente_modifica         VARCHAR2(50),
...
CREATE UNIQUE INDEX
    QUESTIONARIO_UNQ_IDX1
    ON
        QUESTIONARIO (id_utente, id_vacanza);
